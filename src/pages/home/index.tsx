          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Personalized AI coaching that adapts to your goals, tracks your progress, and guides you to success. Join thousands who've already achieved their dreams.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our AI-powered platform combines personalized coaching, progress tracking, and community support to help you achieve any goal.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "AI analyzes your objectives and creates a personalized roadmap with achievable milestones.",
                color: "from-blue-500 to-cyan-500"
              },
              {
                icon: Users,
                title: "Expert Coaching",
                description: "Get guidance from certified coaches and AI trainers available 24/7 to support your journey.",
                color: "from-[#c5a8de] to-pink-500"
              },
              {
                icon: Trophy,
                title: "Progress Tracking",
                description: "Real-time analytics and insights help you stay motivated and adjust your strategy as needed.",
                color: "from-green-500 to-emerald-500"
              },
              {
                icon: Zap,
                title: "AI-Powered Insights",
                description: "Machine learning algorithms provide personalized recommendations to optimize your performance.",
              ...
              },
              {
                ...
                description: "Follow our proven system and see measurable progress within 30 days, or get your money back.",
                color: "from-teal-500 to-green-500"
              }
            ].map((feature, index) => (
              <div key={index} className="group p-8 rounded-2xl border border-gray-100 hover:border-gray-200 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              See how Dream Trainer has transformed lives and helped people achieve their biggest goals.
            </p>
          </div>
            ...
            {[
              {
                name: "Sarah Johnson",
                role: "Entrepreneur",
                content: "Dream Trainer helped me launch my startup in 6 months. The AI coaching was like having a mentor available 24/7.",
                rating: 5,
              ...
              },
              {
                ...
                content: "Lost 40 pounds and completed my first marathon. The progress tracking kept me motivated every day.",
                rating: 5,
              ...
              },
              {
                ...
                role: "Student",
                content: "Improved my grades from C to A+ in one semester. The personalized study plans were game-changing.",
                rating: 5,
              ...
              <div key={index} className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                <div className="flex items-center mb-6">
                  <div className={`w-12 h-12 bg-gradient-to-r ${testimonial.avatar} rounded-full mr-4`}></div>
                  <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={index} className={`relative p-8 rounded-2xl border transition-all duration-300 transform hover:-translate-y-2 ${plan.popular ? 'border-[#c5a8de] shadow-xl scale-105' : 'border-gray-200 hover:border-[#c5a8de] hover:shadow-lg'} bg-white`}>
                {plan.popular && (
                ...
                <button className={`w-full py-3 rounded-lg font-semibold transition-all duration-200 transform hover:scale-105 ${plan.popular ? 'bg-gradient-to-r from-blue-600 to-[#c5a8de] text-white hover:from-blue-700 hover:to-[#b399d6]' : 'border-2 border-gray-300 text-gray-700 hover:border-[#c5a8de] hover:text-[#c5a8de]'}`}>
                  Get Started
                </button>
              </div>
            ))}
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-[#c5a8de]">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 w-full">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join thousands of successful individuals who've already achieved their goals with Dream Trainer.
          </p>
