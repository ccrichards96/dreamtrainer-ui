...
const SOCIAL_FIELDS: {
  ...
  { key: "linkedin", label: "LinkedIn", icon: <Linkedin className="w-4 h-4" />, placeholder: "https://linkedin.com/in/..." },
  { key: "twitter", label: "X (Twitter)", icon: <Twitter className="w-4 h-4" />, placeholder: "https://x.com/..." },
  { key: "facebook", label: "Facebook", icon: <Facebook className="w-4 h-4" />, placeholder: "https://facebook.com/..." },
  { key: "instagram", label: "Instagram", icon: <Instagram className="w-4 h-4" />, placeholder: "https://instagram.com/..." },
  { key: "youtube", label: "YouTube", icon: <Youtube className="w-4 h-4" />, placeholder: "https://youtube.com/@..." },
  { key: "tiktok", label: "TikTok", icon: <Music className="w-4 h-4" />, placeholder: "https://tiktok.com/@..." },
  { key: "website", label: "Website", icon: <Globe className="w-4 h-4" />, placeholder: "https://yoursite.com" },
];
