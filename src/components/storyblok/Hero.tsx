    ...
    <div {...storyblokEditable(blok)} className={containerClasses} style={style}>
      ...
      {blok.showGradients !== false && (
        <div aria-hidden="true" className="flex absolute -top-96 start-1/2 transform -translate-x-1/2">
          <div className={`bg-gradient-to-r ${blok.gradientColor1 ? `from-[${blok.gradientColor1}]` : 'from-violet-300/50'} ${blok.gradientColor2 ? `to-[${blok.gradientColor2}]` : 'to-purple-100'} blur-3xl w-[400px] h-[700px] rotate-[-60deg] transform -translate-x-40 dark:from-violet-900/50 dark:to-purple-900`}></div>
                ...
                {blok.secondaryButtonText && (
                  ...
                  >
                    {blok.secondaryButtonIcon && (
                      <div dangerouslySetInnerHTML={{ __html: blok.secondaryButtonIcon }} />
                    )}
                    {blok.secondaryButtonText}
                  </a>
                )}
