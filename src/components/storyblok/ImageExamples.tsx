...
const basicImageBlok = {
  image_url: {
    filename: 'https://images.unsplash.com/photo-1633114128174-2f8aa49759b0?auto=format&fit=crop&w=800&q=80'
  },
...
const avatarImageBlok = {
  image_url: {
    filename: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?auto=format&fit=crop&w=400&q=80'
  },
...
const heroImageBlok = {
  image_url: {
    filename: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&w=1200&q=80'
  },
...
const galleryImageBlok = {
  image_url: {
    filename: 'https://images.unsplash.com/photo-1518837695005-2083093ee35b?auto=format&fit=crop&w=400&q=80'
  },
...
const legacyImageBlok = {
  image_url: {
    filename: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&w=800&q=80'
  },
    ...
    <div className="p-8 space-y-8">
      ...
      <section>
        ...
        <div className="grid grid-cols-3 gap-4 max-w-md">
          ...
          <ImageComponent blok={{...galleryImageBlok, image_url: { filename: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&w=400&q=80' }}} />
          <ImageComponent blok={{...galleryImageBlok, image_url: { filename: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&w=400&q=80' }}} />
        </div>
      </section>
