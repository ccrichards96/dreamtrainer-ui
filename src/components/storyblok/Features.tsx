  ...
  const FeatureItem: React.FC<{ feature: FeatureItem }> = ({ feature }) => {
    ...
    return (
      <div className="text-center">
        {/* Icon Container */}
        <div className={`flex justify-center items-center size-12 ${iconBgColor} border ${iconBorderColor} rounded-full mx-auto`}>
          {feature.icon ? (
            <div 
              className={iconColor}
            ...
            <svg className="shrink-0 size-5 text-gray-600 dark:text-neutral-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
