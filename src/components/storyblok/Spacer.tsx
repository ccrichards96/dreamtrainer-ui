...
const Spacer: React.FC<{blok: SpacerBlok}> = ({ blok }) => {
  ...
  // Handle height
  if (blok.height) {
    if (blok.height.includes('px') || blok.height.includes('rem') || blok.height.includes('vh') || blok.height.includes('%') || blok.height.includes('em')) {
  ...
  // Handle width
  if (blok.width) {
    if (blok.width.includes('px') || blok.width.includes('rem') || blok.width.includes('vw') || blok.width.includes('%') || blok.width.includes('em')) {
  ...
  if (blok.sm_height) {
    if (blok.sm_height.includes('px') || blok.sm_height.includes('rem') || blok.sm_height.includes('vh') || blok.sm_height.includes('%') || blok.sm_height.includes('em')) {
  ...
  if (blok.md_height) {
    if (blok.md_height.includes('px') || blok.md_height.includes('rem') || blok.md_height.includes('vh') || blok.md_height.includes('%') || blok.md_height.includes('em')) {
  ...
  if (blok.lg_height) {
    if (blok.lg_height.includes('px') || blok.lg_height.includes('rem') || blok.lg_height.includes('vh') || blok.lg_height.includes('%') || blok.lg_height.includes('em')) {
  ...
  if (blok.xl_height) {
    if (blok.xl_height.includes('px') || blok.xl_height.includes('rem') || blok.xl_height.includes('vh') || blok.xl_height.includes('%') || blok.xl_height.includes('em')) {
  ...
  if (blok.sm_width) {
    if (blok.sm_width.includes('px') || blok.sm_width.includes('rem') || blok.sm_width.includes('vw') || blok.sm_width.includes('%') || blok.sm_width.includes('em')) {
  ...
  if (blok.md_width) {
    if (blok.md_width.includes('px') || blok.md_width.includes('rem') || blok.md_width.includes('vw') || blok.md_width.includes('%') || blok.md_width.includes('em')) {
  ...
  if (blok.lg_width) {
    if (blok.lg_width.includes('px') || blok.lg_width.includes('rem') || blok.lg_width.includes('vw') || blok.lg_width.includes('%') || blok.lg_width.includes('em')) {
  ...
  if (blok.xl_width) {
    if (blok.xl_width.includes('px') || blok.xl_width.includes('rem') || blok.xl_width.includes('vw') || blok.xl_width.includes('%') || blok.xl_width.includes('em')) {
  ...
  if (blok.background_color) {
    if (blok.background_color.startsWith('#') || blok.background_color.startsWith('rgb') || blok.background_color.startsWith('hsl')) {
