...
export const ImagePresets = {
  avatar: (filename: string, alt: string): ImageBlok =>
    createImageBlok({
      image_url: { filename },
      alt,
      aspectRatio: "square",
  ...
  hero: (filename: string, alt: string): ImageBlok =>
    createImageBlok({
      image_url: { filename },
      alt,
      aspectRatio: "video",
  ...
  thumbnail: (filename: string, alt: string): ImageBlok =>
    createImageBlok({
      image_url: { filename },
      alt,
      aspectRatio: "square",
  ...
  gallery: (filename: string, alt: string): ImageBlok =>
    createImageBlok({
      image_url: { filename },
      alt,
      aspectRatio: "photo",
  ...
  basic: (filename: string, alt: string): ImageBlok =>
    createImageBlok({
      image_url: { filename },
      alt,
      objectFit: "cover",
