...
const Section: React.FC<{ blok: SectionBlok }> = ({ blok }) => {
  ...
  if (blok.paddingTop) {
    if (
      blok.paddingTop.includes("px") ||
      blok.paddingTop.includes("rem") ||
      blok.paddingTop.includes("%") ||
      blok.paddingTop.includes("vh")
    ) {
  ...
  if (blok.paddingBottom) {
    if (
      blok.paddingBottom.includes("px") ||
      blok.paddingBottom.includes("rem") ||
      blok.paddingBottom.includes("%") ||
      blok.paddingBottom.includes("vh")
    ) {
  ...
  if (blok.paddingLeft) {
    if (
      blok.paddingLeft.includes("px") ||
      blok.paddingLeft.includes("rem") ||
      blok.paddingLeft.includes("%") ||
      blok.paddingLeft.includes("vw")
    ) {
  ...
  if (blok.paddingRight) {
    if (
      blok.paddingRight.includes("px") ||
      blok.paddingRight.includes("rem") ||
      blok.paddingRight.includes("%") ||
      blok.paddingRight.includes("vw")
    ) {
  ...
  if (blok.marginTop) {
    if (
      blok.marginTop.includes("px") ||
      blok.marginTop.includes("rem") ||
      blok.marginTop.includes("%") ||
      blok.marginTop.includes("vh")
    ) {
  ...
  if (blok.marginBottom) {
    if (
      blok.marginBottom.includes("px") ||
      blok.marginBottom.includes("rem") ||
      blok.marginBottom.includes("%") ||
      blok.marginBottom.includes("vh")
    ) {
  ...
  if (blok.marginLeft) {
    if (
      blok.marginLeft.includes("px") ||
      blok.marginLeft.includes("rem") ||
      blok.marginLeft.includes("%") ||
      blok.marginLeft.includes("vw")
    ) {
  ...
  if (blok.marginRight) {
    if (
      blok.marginRight.includes("px") ||
      blok.marginRight.includes("rem") ||
      blok.marginRight.includes("%") ||
      blok.marginRight.includes("vw")
    ) {
  ...
  if (blok.minHeight) {
    if (
      blok.minHeight.includes("px") ||
      blok.minHeight.includes("rem") ||
      blok.minHeight.includes("vh") ||
      blok.minHeight.includes("%")
    ) {
  ...
  if (blok.maxWidth) {
    if (
      blok.maxWidth.includes("px") ||
      blok.maxWidth.includes("rem") ||
      blok.maxWidth.includes("vw") ||
      blok.maxWidth.includes("%")
    ) {
