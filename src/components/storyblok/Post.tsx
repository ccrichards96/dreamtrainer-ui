                          ...
                          <ul className="text-xs space-x-3">
                            {author.articles_count && (
                              <li className="inline-block">
                                <span className="font-semibold text-gray-200 dark:text-neutral-200">{author.articles_count}</span>
                                <span className="text-gray-400 dark:text-neutral-400"> articles</span>
                              </li>
                            )}
                            {author.followers_count && (
                              <li className="inline-block">
                                <span className="font-semibold text-gray-200 dark:text-neutral-200">{author.followers_count}</span>
...
const SocialShareButton: React.FC<{ platform: string; onClick?: () => void }> = ({ platform, onClick }) => {
  const getSocialIcon = () => {
    ...
    <nav className="flex mb-6" aria-label="Breadcrumb">
      <ol className="inline-flex items-center space-x-1 md:space-x-3">
        <li className="inline-flex items-center">
          <a href="/blog" className="text-gray-700 hover:text-blue-600 dark:text-neutral-400 dark:hover:text-blue-500">
            Blog
          </a>
          <ChevronRight />
        </li>
